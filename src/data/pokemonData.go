...
var PokemonList []string = []string{"meltan", "melmetal", "marowak-alola", "sandshrew-alola", "sandslash-alola", "rattata-alola", "raticate-alola", "raichu-alola",
"grimer-alola", "muk-alola", "diglett-alola", "dugtrio-alola", "exeggutor-alola",
...
"shieldon","bastiodon","burmy","wormadam","wormadam-plant","wormadam-sandy","wormadam-trash","mothim","combee","vespiquen",
...
"uxie","mesprit","azelf","dialga","palkia","heatran","regigigas","giratina-origin", "giratina-altered",
"cresselia","phione","manaphy","darkrai","shaymin", "shaymin-sky","arceus","victini","snivy",
